...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.permitAll().antMatchers("/typeSplit").permitAll().antMatchers("/welcomePage").permitAll().antMatchers("/montlySplit").permitAll().antMatchers("/registration").permitAll().antMatchers("/admin/**").hasAuthority("ADMIN")
